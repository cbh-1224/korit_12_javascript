...
// 6. unshift()
let newIndex = scores.unshift(4.5); // 0번지에 새 element 추가 후 새로운 length값 return
...
// 8. splice()
scores.splice(1, 0, 'B+', '100점', 4.0); // 1번지에 아무것도 삭제하지않고(0),
//'B+', '100점', 4.0이라는 3개의 element를 scores 배열에 추가한다는 의미
...
/**
 * 이번 예시는 배열 내에 객체가 있는데, 걔의 ponit가 80점 초과인 애들만 모아서 가져올겁니다.
 */
let persons = [
  {
    name: '김영',
...
let pointResult = persons.filter(function(person){
 ...
 * [
  ...
  { fullName: '김일', lName: '김', fName: '일', email: 'a@test.com' },
  { fullName: '김이', lName: '김', fName: '이', email: 'a@test.com' },
  { fullName: '김삼', lName: '김', fName: '삼', email: 'a@test.com' },
  { fullName: '김사', lName: '김', fName: '사', email: 'a@test.com' }
]
 */
